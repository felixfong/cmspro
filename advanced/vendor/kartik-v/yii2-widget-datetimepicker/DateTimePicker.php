    ...
    public function init()
    {
        ...
        if (empty($this->layout)) {
            if ($this->type == self::TYPE_COMPONENT_PREPEND) {
                $this->layout = '{input}{picker}{remove}';
            }
    ...
    protected function parseMarkup($input)
    {
        ...
        switch ($this->type) {
            ...
            case self::TYPE_COMPONENT_APPEND:
                ...
                Html::addCssClass($this->_container, "input-group col-sm-4 {$size}date");
                $out = strtr(
                    $this->layout, [
                                     '{input}' => $input,
                ...
                Html::addCssStyle($this->_container, "padding:0px 15px 0px 15px");
